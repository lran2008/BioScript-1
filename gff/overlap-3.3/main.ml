...
let overlap_main () =
  ...
  let _u = Common.print_log "# hashtable of feature arrays made for file2\n" in
  ...
  *)
  ...
  let _u = Hashtbl.iter (fun seq x -> Hashtbl.add h2indices seq (ref 0)) h2 in
  let _u = Common.print_log "# I have created the hashtable of indices for file2\n" in
  ...
  *)
  ...
  let _u= Common.print_log ("# I have treated (sorted and put in temp file) file1 according to what the user wants\n") in
  ...
  *)
  ...
  in
    ...
    *)
      ...
      let currseq1 = Feature.seq currgffline1 and currstr1 = Feature.str currgffline1 in
        ...
        *)
        ...
        let feat2list_restricted = restrict_feat2_list context.strmode context.incltype currgffline1 completefeat2list in
          ...
          *)
        let _u= (overlap_wanted context.mode context.nonred context.inter) 
    ...
    let _u = Common.print_log ("# Overlap did its work ! Now writing output file\n") in
    let _u = Common.remove_sorted_temp_file_if_user_wants context.sorted tmp_sorted_file1 in
    let _u = Common.print_log ("# I have removed the temporary sorted file if it has been created\n") in
      flush outchan;;
